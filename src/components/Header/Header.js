    ...
    return (
        <header className='bg-orange-400 w-full fixed'>
            <nav className='w-full px-4 py-3 lg:px-0  lg:w-5/6 mx-auto flex items-center justify-between'>
                ...
                <ul className={`w-full py-3 lg:py-0 absolute bg-indigo-300 lg:bg-inherit lg:static lg:w-auto  left-0  lg:flex z-10 lg:z-0 duration-300 ease-in lg:spacing-x-3  space-x-5 ${ open? 'top-14': 'top-[-100px]'}` }>
                    <li>
                        <CustomLink to="/">Home</CustomLink>
                    </li>
                    <li>
                        <CustomLink to='/restuarant'>ResTaurant</CustomLink>
                    </li>
                    <li>
